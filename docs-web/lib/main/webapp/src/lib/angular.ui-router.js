...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('angular')) : typeof define === 'function' && define.amd ? define(['exports', 'angular'], factory) : factory(global['@uirouter/angularjs'] = {}, global.angular);
    ...
    return function urlBuilder(state) {
      ...
      var url = !parsed ? stateDec.url : $urlMatcherFactoryProvider.compile(parsed.val, {
        ...
        paramMap: function (paramConfig, isSearch) {
          if (stateDec.reloadOnSearch === false && isSearch) paramConfig = extend(paramConfig || {}, {
            dynamic: true
          });
          return paramConfig;
        }
  ...
  * }]
  ...
  var BrowserLocationConfig = /** @class */function () {
    ...
    BrowserLocationConfig.prototype.baseHref = function (href) {
      return isDefined(href) ? this._baseHref = href : isDefined(this._baseHref) ? this._baseHref : this.applyDocumentBaseHref();
    };
